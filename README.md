...
* If you wish to run windows apps on linux vps, please [Get Crossover](https://www.codeweavers.com/store?ad=1034). Single license can be used on multiple machines. 
